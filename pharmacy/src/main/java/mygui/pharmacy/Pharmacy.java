...
public class Pharmacy {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Order> doctorOrders = new ArrayList<>(),doctorOrders1 = new ArrayList<>(),doctorOrders2 = new ArrayList<>(),doctorOrders3 = new ArrayList<>(),doctorOrders4 = new ArrayList<>();
